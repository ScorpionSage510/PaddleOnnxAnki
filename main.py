...
def preprocess_det(image_path, model_input_size=(960, 960)):
...
def home():
    return '''
    <h1>OCR Auto-Occlusion</h1>
    <p>Utilisez le point de terminaison <code>/ocr</code> pour traiter une image.</p>
...
def ocr_infer():
    ...
    input_blob, (original_width, original_height) = preprocess_det(path)
